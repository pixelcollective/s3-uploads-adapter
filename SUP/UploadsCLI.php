...
class UploadsCLI extends WP_CLI_Command
{
	...
	public function verify_api_keys() {
        ...
        $testFile = realpath(__DIR__ . '/../tests/data/sunflower.jpg');

		$copy = copy($testFile, $s3_path);
	...
	public function create_iam_user( $args, $args_assoc ) {
		...
		try {
			...
			$credentials = $iam->createAccessKey(['UserName' => $username])['AccessKey'];
