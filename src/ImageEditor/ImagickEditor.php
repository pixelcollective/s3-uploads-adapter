...
/**
 * @see https://github.com/humanmade/S3-Uploads/blob/master/inc/class-s3-uploads-image-editor-imagick.php
 */
class ImagickEditor extends \WP_Image_Editor_Imagick {
	...
	protected function _save($image, $filename = null, $mime_type = null) {
		...
		if (! $copy_result) {
			return new WP_Error('unable-to-copy-to-s3');
		}
